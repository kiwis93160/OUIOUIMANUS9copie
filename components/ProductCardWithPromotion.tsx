    ...
    >
      ...
      <div className="flex w-full flex-1 flex-col items-center">
        <div className="flex w-full items-baseline justify-between gap-2">
          <p
            className="flex-1 text-left font-extrabold text-gray-900 leading-snug text-[clamp(0.95rem,2.11vw,1.16rem)] break-words text-balance whitespace-normal [hyphens:auto] tracking-tight"
          >
            {product.nom_produit}
          </p>
          <p className="shrink-0 whitespace-nowrap text-right font-bold text-[clamp(1.09rem,2.04vw,1.29rem)] text-gray-800">
