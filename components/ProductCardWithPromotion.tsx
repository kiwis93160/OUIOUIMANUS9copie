  ...
  return (
    ...
    >
      ...
      <img
        ...
        className={`w-full object-cover ${immersiveMobile ? 'h-[58dvh] min-h-[45dvh] max-h-[62dvh] rounded-none mb-0' : 'mb-2 aspect-[4/3] rounded-xl sm:aspect-square'}`}
      />
      ...
      <div className={`flex w-full flex-1 min-h-0 flex-col items-center ${immersiveMobile ? 'bg-[#d5bdd0] px-4 py-3' : ''}`}>
        ...
        {/* Description */}
        <p className={`mt-1 px-1 text-left text-sm text-gray-600 ${immersiveMobile ? 'line-clamp-4' : 'max-h-10 overflow-hidden line-clamp-2'}`}>
          {product.description}
        </p>
